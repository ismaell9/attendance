...
class mod_attendance_structure {
     ...
     * som3a
     * @param array $params
     * @return moodle_url of attendanceHelper
     */
    public function url_Helper($params=array()) {
        $params = array_merge(array('id' => $this->cm->id), $params);
        return new moodle_url('/mod/attendance/help.php', $params);
    }

    /**
     * som3a
     * @param array $params
     * @return moodle_url of requestAbs
     */
    public function url_requestAbs($params=array()) {
        $params = array_merge(array('id' => $this->cm->id), $params);
        return new moodle_url('/mod/attendance/requestAbs.php', $params);
    }
