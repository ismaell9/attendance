...
class attendance_tabs implements renderable {
    ...
    /** Absentee tab */
    const TAB_ABSENTEE      = 10;
    /** Helper  som3a*/
    const TAB_HELPER        = 9;
    /** Request Absence som3a */
    const TAB_ABS = 11;
    /** @var int current tab */
    public $currenttab;
    ...
    public function get_tabs() {
        ...
        /** adding attendance help tab  som3a*/


        $toprow[] = new tabobject(self::TAB_ABS,
            $this->att->url_requestAbs()->out(),
            get_string('requestabs', 'attendance'));

        $toprow[] = new tabobject(self::TAB_HELPER,
            $this->att->url_Helper()->out(),
            get_string('atthelp', 'attendance'));
